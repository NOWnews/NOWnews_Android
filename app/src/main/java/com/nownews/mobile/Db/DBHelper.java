...
import com.nownews.mobile.Db.dbcolumn.DatabaseColumn;
...
public class DBHelper extends SQLiteOpenHelper {
    private static final String DB_NAME = "Nownews";
    ...
    public int delete(String Table_Name, String key) {
        if (db == null)
            db = getWritableDatabase();
        return db.delete(Table_Name, key, null);
    }
